...
import static org.guvnor.sramp.repository.jcr.JCRConstants.OVERLORD;
import static org.guvnor.sramp.repository.jcr.JCRConstants.OVERLORD_ARTIFACT;
import static org.guvnor.sramp.repository.jcr.JCRConstants.OVERLORD_FILENAME;
import static org.guvnor.sramp.repository.jcr.JCRConstants.SRAMP_UUID;
    ...
    public JCRPersistence() {
        ...
        try {
            ...
            if (! manager.hasNodeType(OVERLORD_ARTIFACT)) {
                is = this.getClass().getResourceAsStream("/org/guvnor/s-ramp/guvnor.cnd");
