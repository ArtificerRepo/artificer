   ...
   create table Artifact (
    ...
    alter table Artifact_classifiers 
        add index FK_3ksvuyo0tlsaj7r4jkbljs0fs (Artifact_id), 
        add constraint FK_3ksvuyo0tlsaj7r4jkbljs0fs 
        foreign key (Artifact_id) 
        references Artifact (id);

    alter table Artifact_normalizedClassifiers 
        add index FK_n2luspbu4i64tl1wjeirtp6kc (Artifact_id), 
    ...
    alter table AuditItem_properties 
        add index FK_al7mxsh91w8jvkv2wsp00q84q (AuditItem_id), 
    ...
    alter table OntologyClass 
        ...
        references OntologyClass (surrogateId);
    ...
    alter table OntologyClass 
        ...
        references Ontology (surrogateId);
    ...
    alter table Target_otherAttributes 
        add index FK_jjduupt3sotpqdbwlkgeetkme (Target_id), 
    ...
    alter table WsdlDerived_WsdlDerived 
        ...
        references WsdlDerived (id);

    alter table WsdlDerived_WsdlDerived 
        add index FK_iinooh16ic9iddggfq8qp6ibi (WsdlDerived_id), 
    ...
    alter table WsdlDocument_Artifact 
        add index FK_kud7h93gwnv1tb8ccef0kpyle (WsdlDocument_id), 
        add constraint FK_kud7h93gwnv1tb8ccef0kpyle 
        foreign key (WsdlDocument_id) 
        references WsdlDocument (id);
    ...
    alter table WsdlDocument_WsdlDerived 
        add index FK_ghhcidjvqgivgb2k1usqg620u (WsdlDocument_id), 
    ...
    alter table XsdDocument_Artifact 
        add index FK_q7lklcfoq767xuoxbby7x8be7 (XsdDocument_id), 
        add constraint FK_q7lklcfoq767xuoxbby7x8be7 
        foreign key (XsdDocument_id) 
        references XsdDocument (id);
