...
import org.artificer.shell.commands.archive.RemoveEntryArchiveCommand;
import org.artificer.shell.commands.core.ClassificationCommand;
import org.artificer.shell.commands.core.ConnectCommand;
import org.artificer.shell.commands.core.CreateArtifactCommand;
import org.artificer.shell.commands.core.DeleteCommand;
import org.artificer.shell.commands.core.DeleteContentCommand;
import org.artificer.shell.commands.core.DisconnectCommand;
import org.artificer.shell.commands.core.GetContentCommand;
import org.artificer.shell.commands.core.GetMetaDataCommand;
import org.artificer.shell.commands.core.PropertyCommand;
import org.artificer.shell.commands.core.QueryCommand;
import org.artificer.shell.commands.core.RefreshMetaDataCommand;
import org.artificer.shell.commands.core.ShowMetaDataCommand;
import org.artificer.shell.commands.core.StatusCommand;
import org.artificer.shell.commands.core.UpdateContentCommand;
import org.artificer.shell.commands.core.UpdateMetaDataCommand;
import org.artificer.shell.commands.core.UploadArtifactCommand;
import org.artificer.shell.commands.ontology.UpdateOntologyCommand;
import org.artificer.shell.api.ShellCommand;
import org.artificer.shell.commands.CommandNotFoundCommand;
import org.artificer.shell.commands.EchoCommand;
import org.artificer.shell.commands.ExitCommand;
import org.artificer.shell.commands.HelpCommand;
import org.artificer.shell.commands.archive.AddEntryArchiveCommand;
import org.artificer.shell.commands.archive.CloseArchiveCommand;
import org.artificer.shell.commands.archive.ListArchiveCommand;
import org.artificer.shell.commands.archive.ListEntryArchiveCommand;
import org.artificer.shell.commands.archive.NewArchiveCommand;
import org.artificer.shell.commands.archive.OpenArchiveCommand;
import org.artificer.shell.commands.archive.PackArchiveCommand;
import org.artificer.shell.commands.archive.UpdateEntryArchiveCommand;
import org.artificer.shell.commands.archive.UploadArchiveCommand;
import org.artificer.shell.commands.audit.ShowAuditTrailCommand;
import org.artificer.shell.commands.maven.DeployCommand;
import org.artificer.shell.commands.ontology.DeleteOntologyCommand;
import org.artificer.shell.commands.ontology.GetOntologyCommand;
import org.artificer.shell.commands.ontology.ListOntologiesCommand;
import org.artificer.shell.commands.ontology.UploadOntologyCommand;
import org.artificer.shell.commands.storedquery.CreateStoredQueryCommand;
import org.artificer.shell.commands.storedquery.DeleteStoredQueryCommand;
import org.artificer.shell.commands.storedquery.ExecuteStoredQueryCommand;
import org.artificer.shell.commands.storedquery.GetStoredQueryCommand;
import org.artificer.shell.commands.storedquery.ListStoredQueriesCommand;
import org.artificer.shell.commands.storedquery.UpdateStoredQueryCommand;
