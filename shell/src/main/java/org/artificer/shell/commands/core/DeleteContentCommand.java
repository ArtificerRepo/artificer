 ...
 * @author Brett Meyer
 */
public class DeleteContentCommand extends BuiltInShellCommand {

	// TODO: Heavily duplicates DeleteCommand -- refactor!
	...
	public boolean execute() throws Exception {
		...
		try {
			client.deleteArtifactContent(artifact.getUuid(), ArtifactType.valueOf(artifact));
			print(Messages.i18n.format("DeleteContent.Success", artifact.getName())); //$NON-NLS-1$
		} catch (Exception e) {
			print(Messages.i18n.format("DeleteContent.Failure")); //$NON-NLS-1$
