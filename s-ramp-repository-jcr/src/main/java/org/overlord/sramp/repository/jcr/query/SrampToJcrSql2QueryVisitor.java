...
//    private Selector rootFrom;
     ...
     */
    public SrampToJcrSql2QueryVisitor(Session session, ClassificationHelper classificationHelper) throws SrampException {
     ...
     */
    @Override
    public void visit(org.overlord.sramp.common.query.xpath.ast.Query node) {
        this.error = null;
