...
/**
 * A test class for a {@link VdbManifestArtifactBuilder}.
 */
...
public final class VdbManifestArtifactBuilderTest extends TeiidIntegrationTest {
    ...
    public void shouldDeriveParserParserTestVdbArtifacts() throws Exception {
        ...
        final Collection<BaseArtifactType> derivedArtifacts = builder.buildArtifacts(
                this.vdbManifestArtifact, IOUtils.toByteArray(vdbStream)).getDerivedArtifacts();
    ...
    public void shouldNotDeriveNonVdbManifests() throws Exception {
        ...
        builder.buildArtifacts(this.vdbManifestArtifact, IOUtils.toByteArray(notAVdbManifestStream));
    }
