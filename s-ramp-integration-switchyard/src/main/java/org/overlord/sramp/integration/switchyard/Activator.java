...
public class Activator implements BundleActivator {
    ...
    public void start(BundleContext context) throws Exception {
        context.registerService(ZipToSrampArchiveProvider.class.getName(), new SwitchYardAppToSrampArchiveProvider(), null);
        context.registerService(DeriverProvider.class.getName(), new SwitchYardDeriverProvider(), null);
    }
