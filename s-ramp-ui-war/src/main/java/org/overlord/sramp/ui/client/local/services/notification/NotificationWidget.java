...
import org.overlord.sramp.ui.client.local.events.MouseInEvent.HasMouseInHandlers;
import org.overlord.sramp.ui.client.local.events.MouseOutEvent;
import org.overlord.sramp.ui.client.local.events.MouseOutEvent.HasMouseOutHandlers;
 ...
 */
@Templated("/org/overlord/sramp/ui/client/local/site/artifacts.html#growl-dialog")
@Dependent
public class NotificationWidget extends Composite implements HasMouseInHandlers, HasMouseOutHandlers {
    ...
    /**
     * @see org.overlord.sramp.ui.client.local.events.MouseOutEvent.HasMouseOutHandlers#addMouseOutHandler(org.overlord.sramp.ui.client.local.events.MouseOutEvent.Handler)
     */
    @Override
    public HandlerRegistration addMouseOutHandler(
            org.overlord.sramp.ui.client.local.events.MouseOutEvent.Handler handler) {
        return addHandler(handler, MouseOutEvent.getType());
    }

    /**
     * @see org.overlord.sramp.ui.client.local.events.MouseInEvent.HasMouseInHandlers#addMouseInHandler(org.overlord.sramp.ui.client.local.events.MouseInEvent.Handler)
     */
    @Override
    public HandlerRegistration addMouseInHandler(
            org.overlord.sramp.ui.client.local.events.MouseInEvent.Handler handler) {
