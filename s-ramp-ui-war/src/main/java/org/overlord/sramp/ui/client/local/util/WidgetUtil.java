...
public final class WidgetUtil {
    ...
    public static native final void addMouseHandlers(final IMouseInOutWidget widget) /*-{
        var element = widget.@org.overlord.sramp.ui.client.local.util.IMouseInOutWidget::getElement()();
        $wnd.jQuery(element).mouseenter(function() {
            widget.@org.overlord.sramp.ui.client.local.util.IMouseInOutWidget::onMouseIn()();
        });
        $wnd.jQuery(element).mouseleave(function() {
            widget.@org.overlord.sramp.ui.client.local.util.IMouseInOutWidget::onMouseOut()();
        });
    }-*/;
