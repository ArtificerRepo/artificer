...
import org.overlord.commons.karaf.commands.configure.AbstractFabricProfileCommand;
 ...
 */
@Command(scope = "overlord:s-ramp", name = "configureFabric")
public class ConfigureFabricCommand extends AbstractFabricProfileCommand {
    ...
    protected Object doExecute() throws Exception {
        org.overlord.commons.karaf.commands.configure.ConfigureFabricCommand overlordConfigure = new org.overlord.commons.karaf.commands.configure.ConfigureFabricCommand();
        overlordConfigure.setBundleContext(bundleContext);
        overlordConfigure.setPassword(password);
