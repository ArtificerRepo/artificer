...
1. JCR (ModeShape) - used as the persistence engine, where all Artificer data is stored.  Artifacts
and ontologies are both stored as nodes in a JCR tree.  All Artificer queries are mapped to JCRSQL2
