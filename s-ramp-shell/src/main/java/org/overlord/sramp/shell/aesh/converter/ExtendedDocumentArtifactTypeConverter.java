...
/**
 * Converts the input string to an Artifact type object
 * 
 * @author David Virgil Naranjo
 */
public class ExtendedDocumentArtifactTypeConverter implements Converter<ArtifactType, ConverterInvocation> {
