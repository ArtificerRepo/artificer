...
@Provider
@ServerInterceptor
@Produces(org.artificer.atom.MediaType.APPLICATION_SRAMP_ATOM_EXCEPTION)
@Consumes(org.artificer.atom.MediaType.APPLICATION_SRAMP_ATOM_EXCEPTION)
public class ArtificerAtomExceptionProvider implements ExceptionMapper<ArtificerAtomException>,
		MessageBodyWriter<ArtificerAtomException>, MessageBodyReader<ArtificerAtomException> {

	/**
	 * Constructor.
	 */
	public ArtificerAtomExceptionProvider() {
	}
	 ...
	 */
	@Override
	public Response toResponse(ArtificerAtomException exception) {
		ResponseBuilder builder = Response.status(500);
		builder.header("Error-Message", getRootCause(exception).getMessage()); //$NON-NLS-1$
		builder.type(org.artificer.atom.MediaType.APPLICATION_SRAMP_ATOM_EXCEPTION);
	...
	public boolean isWriteable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
		return ArtificerAtomException.class.equals(type);
	}
	 ...
	 */
	@Override
	public long getSize(ArtificerAtomException t, Class<?> type, Type genericType, Annotation[] annotations,
			MediaType mediaType) {
		return -1l;
	}
	 ...
	 */
	@Override
	public void writeTo(ArtificerAtomException error, Class<?> type, Type genericType, Annotation[] annotations,
	...
	public boolean isReadable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
		return ArtificerAtomException.class.equals(type)
				|| org.artificer.atom.MediaType.APPLICATION_SRAMP_ATOM_EXCEPTION_TYPE.equals(mediaType);
	}
	 ...
	 */
	@Override
	public ArtificerAtomException readFrom(Class<ArtificerAtomException> type, Type genericType, Annotation[] annotations,
