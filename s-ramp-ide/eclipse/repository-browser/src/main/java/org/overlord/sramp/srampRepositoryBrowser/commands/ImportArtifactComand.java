...
import org.overlord.sramp.srampRepositoryBrowser.dialogs.ImportToRepositoryDialog;
...
public class ImportArtifactComand extends AbstractHandler {
	...
	public static final Logger log = Logger
			.getLogger(ImportArtifactComand.class.getName());
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (!(getView(event) instanceof RepositoryBrowser)) {
			log.log(Level.WARNING,
					"Getting Browser view failed - not instance of RepositoryBrowser");
			return null;
		}
